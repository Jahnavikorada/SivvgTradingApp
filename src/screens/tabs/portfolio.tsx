        ...
        >
            <View style={styles.mainCard}>
              ...
              <View style={styles.userSelectorWrapper}>
                ...
                >
                  ...
                  >
                    ...
                    <Text style={styles.userName}>{selectedMember}</Text>
              ...
              <View style={styles.toggleRow}>
                ...
                >
                  <Text style={[styles.toggleText, view === "Weekly" && { color: "#fff" }]}>
                    Weekly View
                  </Text>
                </TouchableOpacity>
                ...
                >
                  <Text style={[styles.toggleText, view === "Monthly" && { color: "#fff" }]}>
                    Monthly View
                  </Text>
                </TouchableOpacity>
                  ...
                  {showMonthDropdown && (
                    <View style={styles.monthDropdown}>
                      {months.map((m) => (
                        ...
                        >
                          <Text style={styles.monthItemText}>{m}</Text>
                        </TouchableOpacity>
                      ))}
                    </View>
                  )}
